#include "Qroma2BytesWithLengthAndPbProcessor.h"
#include "../../util/logger.h"
#include "../../util/qbase64.h"


void Qroma2BytesWithLengthAndPbProcessor::reset() { }


uint32_t Qroma2BytesWithLengthAndPbProcessor::processBytes(const uint8_t * bytes, uint32_t byteCount, PbCommandsRegistry * pbCommandsRegistry, std::function<void(uint8_t*, uint32_t)> txFn) {
