...
//   _processingMode = QromaBytesProcessingMode_PB_BASE64_COMMANDS;
// }
...
//     setProcessingMode(QromaBytesProcessingMode_PB_BASE64_COMMANDS);
//     commBuffer->reset();
//     return false;
//   }
...
//   logInfo("PRECESSING PB COMMANDS");
